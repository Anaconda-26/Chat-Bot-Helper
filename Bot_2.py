...
TOKEN = '7882286658:AAElPHlUjZ61h4XZWOMn1gHQlkJbdpWXs_8'  # Replace with your actual token
...
async def handle_message(update: Update, context):
    ...
    context_messages.append(messages)
    ...
    try:
        ...
        # response = ollama.chat(model='llama3.1', messages=context_memory[user_id])
